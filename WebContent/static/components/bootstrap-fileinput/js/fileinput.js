    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink, tBtnBrowse,
                ...
                tActionDrag, tTagBef, tTagBef1, tTagBef2, tTagAft, tTagHide, tGeneric, tHtml, tImage, tText, tVideo, tAudio,
...
//	            '</div>';
            ...
            tMain1 = '<div class="input-group {class}">\n' +
                '   {caption}\n' +
                '   <div class="input-group-btn">\n' +
                '       {remove}\n' +
                '       {cancel}\n' +
...
//            tImage = '<button type="button" class="kv-file-remove btn btn-default btn-close" '
//            	+ 'title="关闭当前预览" data-dismiss="modal" aria-hidden="true" style="'
//            	+ 'top: 1px;right: 1px;position: absolute;border-radius: 8px; '
//            	+ 'width: 17px;height: 17px;font-size: 8px;font-weight: 200; '
//            	+ 'padding: 0;background-color: black;"> '
//            	+ '<i class="glyphicon glyphicon-remove" style=" '
//            	+ 'top: 1px; right: 0px;font-weight: 200;font-size: 8px;color: white; '
//            	+ '"></i></button>'
//            	+'<img src="{data}" class="kv-preview-data file-preview-image" title="{caption}" alt="{caption}" ' +
//                STYLE_SETTING + '>\n';
            
            tTagHide = '<input type="hidden" name="' + self.$element.attr("name") + 'Url" value="{hideData}">\n';
        ...
        _initPreviewTemplates: function () {
            var self = this, cfg = self.defaults, tags = self.previewMarkupTags, tagBef, tagAft = tags.tagAfter, tagHide = tags.tagHide;
            $.each(cfg.previewContentTemplates, function (key, value) {
                if (isEmpty(self.previewTemplates[key])) {
                    ...
                    self.previewTemplates[key] = tagBef + value + tagHide + tagAft;
                }
            });
        },
        ...
        _uploadImage: function (_previewId,i,allFiles,_file) {
            var self = this, total = self.getFileStack().length, formdata = new FormData(), outData,
                previewId = _previewId, $thumb, chkComplete, $btnUpload, $btnDelete,
            ...
            fnError = function (jqXHR, textStatus, errorThrown) {
                var op = self.ajaxOperations.uploadThumb,
                    errMsg = self._parseError(op, jqXHR, errorThrown, (allFiles ? _file.name : null));
                setTimeout(function () {
                    if (allFiles) {
            ...
            formdata.append(self.uploadFileAttr, _file, self.filenames[i]);
            ...
            var self = this, caption = self.slug(fname), prevContent, zoomContent = '',
                ...
                getContent = function (c, d, zoom, frameCss) {
                    ...
                    return tmplt.replace(/\{previewId}/g, id).replace(/\{caption}/g, caption)
                        ...
                        .replace(/\{footer}/g, footer).replace(/\{data}/g, d).replace(/\{hideData}/g, d)
                        .replace(/\{template}/g, templ || cat);
                };
            ...
            readFile = function (i) {
                ...
                if ($preview.length && FileReader !== undefined) {
                    ...
                    reader.onload = function (theFile) {
                        ...
                        if (self.simultaneousUpload) {
                        	self._uploadImage(previewId,node,false,file);	
                        }
                    };
    ...
    $.fn.fileinput.defaults = {
        language: 'en', // 语言
        showCaption: true, // 显示路径
        showBrowse: true,  // 显示文件选择按钮
        showPreview: true, // 显示预览
        showRemove: true, // 显示移除按钮
        showUpload: true, // 显示上传按钮
        showCancel: true, // 显示取消上传按钮
        showClose: true,  // 显示关闭按钮
        showUploadedThumbs: true,
        simultaneousUpload: false, // 选择后是否立即上传
